...
# 11 Mar: this version (originally filename 110309_smiles.r)
#
################################################################################
#
...
write(new_compounds,"AvailMols.mat",ncolumns=1)  
...
write.csv(reduced_compounds_sorted,file="all_compounds_indexed.csv") 
...
write(all_smiles,"AllSMILES.smi",ncolumns=1)
