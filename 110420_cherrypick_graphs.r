...
# 14 June: modified to have upper range of 10um
#
################################################################################
#
...
#   screens after xx May 2011 (0, 0.5, 1, 2.5, 5 & 10 um).
#
...
#  AB/28  vol_cmpd_nl        : numeric (0, 5, 12.5, 25, 50, 100)
#  AC/29  cmpd_conc_um       : numeric (0, 1, 2.5, 5, 10, 20)
#
################################################################################
...
# set up a loop to check if a negctrl plate is same as plate for chemical[i]
    for (k in 1:p){              
        ...
        ############# graph drawing, id & saving routine  ###########
                ...
                graph_xlim <- c(0,20)    # set x limits of 0 to 20
